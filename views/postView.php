...
<h2 style="padding-left: 100px;">Commentaires</h2>
...
?>
<?php if ($comment['publication'] == 1 || $_SESSION['pseudo'] == $post['pseudo']) : ?>
<div class="shadow">
  <div class="container">
    <div class="news">
    ...
    <?php
if ((is_logged_in()) && ($_SESSION['pseudo'] == $post['pseudo']) || ($_SESSION['pseudo'] == $comment['author'])) : ?>
            <em><a href="index.post.php?action=deleteComment&amp;id=<?= $comment['id'] ?>">Supprimer</a></em>
<?php endif; ?> 

    </div>
    <?php if (is_logged_in() && $_SESSION['pseudo'] == $post['pseudo'] && $comment['publication'] == 0) : ?>
